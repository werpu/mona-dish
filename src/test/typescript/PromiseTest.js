...
var Promise = Monad_1.Monadish.Promise;
describe('promise tests', function () {
    ...
    it('simple promise', function () {
        ...
        var applyPromise = new Promise(function (apply, reject) {
            setTimeout(function () {
                apply(1);
            }, 1);
        });
    ...
    it("Promise all test", function () {
        ...
        var applyPromise2 = new Promise(function (apply, reject) {
            setTimeout(function () {
                apply(2);
            }, 1);
        });
        var applyPromise3 = Promise.all(applyPromise, applyPromise2);
        var finallyCalled = false;
        var thenCalled = false;
        var then2Called = false;
        applyPromise.then(function (data) {
    ...
    it("Promise race test", function () {
        ...
        var applyPromise3 = Promise.race(applyPromise, applyPromise2);
        var finallyCalled = false;
        var thenCalled = false;
        var then2Called = false;
        applyPromise.then(function (data) {
    ...
    it("Promise chain test", function () {
        ...
        applyPromise.then(function () {
            return new Promise(function (apply, reject) {
                setTimeout(function () {
                    apply(2);
                }, 6);
            });
    ...
    it("Promise chain3 test", function () {
        ...
        var applyPromise3 = Promise.all(applyPromise, applyPromise2).then(function () {
            promise3Called = true;
        });
        jasmine.clock().tick(8);
        expect(chainExecuted).toBe(true);
