...
describe('DOMQuery tests', function () {
    ...
    <div id="embed1">
       ...
       `;
        ...
        expect(data === null || data === void 0 ? void 0 : data["id_1"][0]).to.eq("booga");
        expect(data === null || data === void 0 ? void 0 : data["id_2"][0]).to.eq("id_2_val");
        expect(data === null || data === void 0 ? void 0 : data["id_3"][0]).to.eq("hello world");
        expect(data === null || data === void 0 ? void 0 : data["cc_1"][0]).to.eq("Mastercard");
        expect(data === null || data === void 0 ? void 0 : data["val_5"][0]).to.eq("akaka");
        expect(data === null || data === void 0 ? void 0 : data["page:animals"].length).to.eq(2);
        expect(data === null || data === void 0 ? void 0 : data["page:animals"][0]).to.eq("Cat");
        expect(data === null || data === void 0 ? void 0 : data["page:animals"][1]).to.eq("Fox");
    });
    ...
    it("copy attributes must traverse nonce properly", function () {
        ...
        expect(probe2.getAsElem(0).value.nonce).to.be.eq('nonceValue');
        let element2 = DomQuery.fromMarkup('<div></div>');
        element2.copyAttrs(probe2);
        expect(element2.getAsElem(0).value.nonce).to.be.eq('nonceValue');
