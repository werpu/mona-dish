...
var Config = /** @class */ (function (_super) {
    ...
    Config.prototype.append = function () {
        ...
        var pathExists = this.getIf.apply(this, __spreadArray([], __read(keys), false)).isPresent();
        this.buildPath(keys);
        var finalKeyArrPos = this.arrayIndex(lastKey);
        if (finalKeyArrPos > -1) {
            throw Error("Append only possible on non array properties, use assign on indexed data");
        }
        var value = this.getIf.apply(this, __spreadArray([], __read(keys), false)).value;
        if (!Array.isArray(value)) {
            value = this.assign.apply(this, __spreadArray([], __read(keys), false)).value = [value];
        }
        if (pathExists) {
            value.push({});
        }
    ...
    Config.prototype.appendIf = function (condition) {
        ...
        return this.append.apply(this, __spreadArray([], __read(keys), false));
    };
    ...
    Config.prototype.assignIf = function (condition) {
        ...
        return condition ? this.assign.apply(this, __spreadArray([], __read(keys), false)) : { value: null };
    };
